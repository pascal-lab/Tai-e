...
* _Get familiar with Tai-e_: See <<program-abstraction#program-abstraction,Program Abstraction in Tai-e>> for more information about Tai-e, such as the important classes that you might use when writing new analysis.
