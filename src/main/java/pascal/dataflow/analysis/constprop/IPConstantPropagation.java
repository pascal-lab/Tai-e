...
import pascal.callgraph.cha.CHACallGraphBuilder;
import pascal.dataflow.analysis.EdgeTransfer;
import pascal.dataflow.analysis.IPDataFlowAnalysis;
import pascal.dataflow.solver.IPSolver;
import pascal.dataflow.solver.IPWorkListSolver;
import pascal.icfg.CallEdge;
import pascal.icfg.ICFG;
import pascal.icfg.JimpleICFG;
    ...
    private EdgeTransfer<Unit, FlowMap> edgeTransfer = new EdgeTransfer<Unit, FlowMap>() {
        ...
        public void transferCallEdge(CallEdge<Unit> edge, FlowMap callSiteInFlow, FlowMap edgeFlow) {
            ...
            for (int i = 0; i < args.size(); ++i) {
                ...
                Value argValue = cp.toValue(callSiteInFlow, arg);
