...
package pascal.panda.pta.core.solver;

import pascal.panda.pta.core.ProgramManager;
import pascal.panda.pta.core.context.ContextInsensitiveSelector;
import pascal.panda.pta.core.context.OneCallSelector;
import pascal.panda.pta.core.context.OneObjectSelector;
import pascal.panda.pta.core.context.OneTypeSelector;
import pascal.panda.pta.core.context.TwoCallSelector;
import pascal.panda.pta.core.context.TwoObjectSelector;
import pascal.panda.pta.core.context.TwoTypeSelector;
import pascal.panda.pta.core.cs.MapBasedCSManager;
import pascal.panda.pta.core.heap.AllocationSiteBasedModel;
import pascal.panda.pta.jimple.JimpleProgramManager;
import pascal.panda.pta.options.Options;
import pascal.panda.pta.plugin.AnalysisTimer;
import pascal.panda.pta.plugin.CompositePlugin;
import pascal.panda.pta.plugin.Preprocessor;
import pascal.panda.pta.plugin.ResultPrinter;
import pascal.panda.pta.plugin.ThreadHandler;
import pascal.panda.pta.set.HybridPointsToSet;
import pascal.panda.pta.set.PointsToSetFactory;
