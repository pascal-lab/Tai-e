...
class MetaObjHelper {
     ...
     */
    private final static Descriptor REFLECTION_DESC = () -> "ReflectionMetaObj";

    /**
     * Descriptor for the meta objects generated by reflection log.
     */
    private final static Descriptor REFLECTION_LOG_DESC = () -> "ReflectionLogMetaObj";

    /**
     * Descriptor for the array objects generated by
     * Class.get[Declared][Constructor|Method|Field]s().
     */
    private final static Descriptor REFLECTION_ARRAY_DESC = () -> "ReflectionMetaObjArray";

    /**
     * Descriptor for unknown meta objects.
     */
    private final static Descriptor UNKNOWN_REFLECTION_DESC = () -> "UnknownReflectionMetaObj";

    /**
     * Descriptor for annotation objects.
     */
    private final static Descriptor ANNOTATION_DESC = () -> "AnnotationObj";
