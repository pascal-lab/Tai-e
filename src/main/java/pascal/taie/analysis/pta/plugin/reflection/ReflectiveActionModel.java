...
class ReflectiveActionModel extends AbstractModel {
    ...
    /**
     * If a reflective invocation is annotated by the log, and the given
     * meta object is not generated by the log, and we treat them
     * ({@code metaObj} for {@code invoke}) as an invalid resolution
     * and ignore it.
     */
    private boolean isInvalid(Invoke invoke, CSObj metaObj) {
